...
const AdminDashboard = () => {
  ...
  const styles = `
    ...
    .icon-registration { background: linear-gradient(135deg, #667eea, #764ba2); color: white; }
    .icon-payment { background: linear-gradient(135deg, #43e97b, #38f9d7); color: white; }
    .icon-attendance { background: linear-gradient(135deg, #ff9a9e, #fecfef); color: white; }
    .icon-employee { background: linear-gradient(135deg, #a8edea, #fed6e3); color: #2c3e50; }
